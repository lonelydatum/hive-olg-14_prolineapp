...
function start() {
	...
	tl.from(_commonJsPROLINEJs.dom.phoneMain, .5, { y: 65 }, 'f1+=.3');

	tl.add('f2', '+=.6');
	tl.to("#t1", .7, { x: 120, ease: Sine.easeOut }, 'f2');
	tl.add((0, _commonJsPROLINEJs.rotate)(0, 9), 'f2');
	tl.to(_commonJsPROLINEJs.dom.phoneMain, .4, { y: -42 }, 'f2');
	...
	tl.to(_commonJsPROLINEJs.dom.phoneMain, .3, { x: 319 }, 'bump');
